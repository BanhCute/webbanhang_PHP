...
<div class="container">
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="<?= ROOT_URL ?>/Product/update" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <img id="preview"
                                        src="<?= $product['image'] ? ROOT_URL . '/public/uploads/products/' . $product['image'] : ROOT_URL . '/public/images/no-image.png' ?>"
...
<script>
    function previewImage(input) {
        ...
        if (input.files && input.files[0]) {
            ...
            preview.src = '<?= $product['image'] ? ROOT_URL . '/public/uploads/products/' . $product['image'] : ROOT_URL . '/public/images/no-image.png' ?>';
        }
    }
